...
- Card-based layout — each section or metric in its own rounded card with subtle border and background (#252547)
...
4. **Data Tables** — compact tables with dark styling, colored status badges where applicable
5. **Insights** — short bullet-point findings at the bottom

Prioritize visual density — show more data, less narrative. Every card should have a clear title and value.