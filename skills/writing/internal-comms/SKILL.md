---
name: internal-comms
description: Resources to help write all kinds of internal communications using common internal-communication formats. Use this skill whenever asked to write some sort of internal communication (status reports, leadership updates, 3P updates, company newsletters, FAQs, incident reports, project updates, etc.).
---

# Internal Communications

This skill helps write internal communications using common internal-communication formats. Identify the communication type from the request, then follow the relevant section below for formatting, tone, and content gathering.
...
If the communication type doesn't clearly match one of the formats below, use the **General comms** guidance and ask for clarification or more context about the desired format.

## Progress/Plans/Problems updates

A 3P update stands for "Progress, Plans, Problems." The main audience is executives, leadership, and other teammates. They're meant to be very succinct and to-the-point: think something readable in 30-60 seconds or less. They're also for people with some, but not a lot of, context on what the team does.
...
- Calendar: non-recurring meetings of high importance, like product reviews
...
**Formatting:** The format is always the same — very strict. Never use any formatting other than this. Pick an emoji that is fun and captures the vibe of the team and update.
...
Each section should be no more than 1-3 sentences: clear and to the point. It should be data-driven, generally including metrics where possible. The tone should be very matter-of-fact, not prose-heavy.
...
- Documents: recent docs that got a lot of attention — company-wide vision docs, plans for the upcoming quarter or half, things authored by critical executives
- External press: any articles or press received over the past week

If you don't have access, ask the user what they want to cover; you'll mostly be polishing and fitting to this format.
...
Each week, lots of questions get asked across a company. The goal is to summarize those questions and answer them, keeping employees well-informed and on the same page. Two jobs:

- Find questions that are big sources of confusion for many employees, generally about things that affect a large portion of the employee base.
- Give a nicely summarized answer to each question to minimize confusion.
...
- Flag if a question requires executive input or an official response
