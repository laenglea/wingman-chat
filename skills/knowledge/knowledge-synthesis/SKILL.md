...
The last mile of research. Takes raw results from multiple sources and produces a coherent, trustworthy answer.
...
document result: "API Design Doc v3 — updated section 2 to reflect REST decision"
task result: "Task: Finalize API approach — marked complete by Sarah"
```
...
been updated to reflect the decision. The related task is marked complete.

Sources:
- chat: #engineering thread (Jan 14)
- email: "API Decision" from Sarah (Jan 15)
- document: "API Design Doc v3" (updated Jan 15)
...
The design doc was updated to reflect this (document: "API Design Doc v3").
```
...
- document: "API Design Doc v3" last modified Jan 15 — updated specification
```

### Attribution Rules

- Always name the source type (chat, email, document, etc.)
...
- For documents, note the document title
...
**Do not:**
- List results source by source ("From chat: ... From email: ... From documents: ...")
