...
|---------|---------------------|------------|
| Individual item amount | Above a low threshold | Supervisor review |
| Individual item amount | Above a higher threshold | Controller review |
| Total reconciling items | Above a defined threshold | Controller review |
