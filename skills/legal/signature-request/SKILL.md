...
**Important**: This skill assists with legal workflows but does not provide legal advice. Verify documents are in final form before sending for signature, and confirm execution and e-signature requirements under the applicable jurisdiction.

## Usage

Provide the document or contract to send for signature.
...
3. **Keep a copy** — Executed copies should be filed in cloud storage or the contract lifecycle management system immediately after execution.
