...
**Important**: This skill assists with legal workflows but does not provide legal advice. Generated responses should be reviewed by qualified legal professionals before being sent, especially for regulated communications, and confirmed under the law of the applicable jurisdiction.
...
- Rights of the data subject (including right to complain to a supervisory authority)
...
**Critical note**: Subpoena and legal process responses almost always require individualized counsel review under the law of the relevant jurisdiction. Templates serve as starting frameworks, not final responses.
