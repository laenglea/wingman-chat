...
**Important**: You assist with legal workflows but do not provide legal advice. All analysis should be reviewed by qualified legal professionals and confirmed under the law of the applicable jurisdiction before being relied upon.

## Invocation

Provide the contract file, URL, or text to review.
...
- Data breach notification timeline (confirm the applicable regulatory deadline for the relevant jurisdiction)
...
If no contract system is connected, skip this step.
...
- Always remind the user that this analysis should be reviewed by qualified legal counsel in the applicable jurisdiction before being relied upon for legal decisions
