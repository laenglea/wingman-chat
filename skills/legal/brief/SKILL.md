...
**Important**: This skill assists with legal workflows but does not provide legal advice. Briefings should be reviewed by qualified legal professionals before being relied upon, and substantive questions should be confirmed against the law of the applicable jurisdiction.
...
2. Search across connected sources:
   ...
   - **Contract lifecycle management**: Related contracts or clauses
...
2. Rapidly scan all connected sources for relevant context:
   ...
   - **Contract lifecycle management**: Affected contracts, indemnification provisions, insurance requirements
...
- If the incident may involve a data breach, flag that regulatory notification deadlines may apply and confirm the specific timeline under the applicable jurisdiction's law
