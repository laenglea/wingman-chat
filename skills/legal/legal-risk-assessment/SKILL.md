...
**Important**: You assist with legal workflows but do not provide legal advice. Risk assessments should be reviewed by qualified legal professionals, and substantive conclusions confirmed under the law of the applicable jurisdiction. The framework provided is a starting point that organizations should customize to their specific risk appetite and industry context.
...
**Privileged**: [Yes/No - mark as privileged if applicable under local law]
...
- **Securities or disclosure issues**: Any matter that could affect regulatory disclosures or filings
...
- **Specialized expertise needed**: Matters requiring deep domain expertise not available in-house (antitrust/competition, anti-corruption, patent prosecution, etc.)
