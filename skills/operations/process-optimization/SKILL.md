...
description: Analyze and improve business processes. Use when a process is slow, has too many steps, has a bottleneck, or when the user describes an inefficient workflow they want to streamline or fix.
---
